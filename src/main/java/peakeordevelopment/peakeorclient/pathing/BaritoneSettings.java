...
package peakeordevelopment.peakeorclient.pathing;
...
public class BaritoneSettings implements IPathManager.ISettings {
    ...
    private static void loadDescriptions() {
        ...
        addDescription("assumeWalkOnLava", "Allow Baritone to assume it can walk on lava while Fire Resistance is active.");

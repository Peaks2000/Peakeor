...
import peakeordevelopment.peakeorclient.mixin.MapTextureManagerAccessor;
...
public class SaveMapCommand extends Command {
    ...
    private void saveMap(int scale) throws CommandSyntaxException {
        ...
        MapTextureManager.MapInstance texture = textureManager.peakeor$invokeGetOrCreateMapInstance(map.get(DataComponents.MAP_ID), state);
        ...
        try {
            ...
            PeakeorClient.LOG.error(e.toString());
        }
    }

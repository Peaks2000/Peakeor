...
import peakeordevelopment.peakeorclient.systems.modules.misc.swarm.SwarmConnection;
import peakeordevelopment.peakeorclient.systems.modules.misc.swarm.SwarmWorker;
import peakeordevelopment.peakeorclient.systems.modules.world.InfinityMiner;
                ...
                .then(argument("port", IntegerArgumentType.integer(0, 65535))
                    .executes(context -> {
                        ...
                        info(Component.literal("Click here to confirm").setStyle(Style.EMPTY
                            ...
                            .withClickEvent(new PeakeorClickEvent(".swarm join confirm"))
                        ));

...
public class ServerCommand extends Command {
    ...
    private void onReadPacket(PacketEvent.Receive event) {
        ...
        if (event.packet instanceof ClientboundCommandsPacket packet) {
            ...
            packet.getRoot(
                CommandBuildContext.simple(handler.peakeor$getRegistryAccess(), handler.peakeor$getEnabledFeatures()),
                ClientPacketListenerAccessor.peakeor$getCommandNodeFactory()

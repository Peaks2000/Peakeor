...
package peakeordevelopment.peakeorclient.systems.config;
...
public class Config extends System<Config> {
    ...
    public final Setting<Boolean> titleScreenCredits = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show Peakeor credits on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<Boolean> titleScreenSplashes = sgVisual.add(new BoolSetting.Builder()
        ...
        .description("Show Peakeor splash texts on title screen")
        .defaultValue(true)
        .build()
    );
    ...
    public final Setting<String> customWindowTitleText = sgVisual.add(new StringSetting.Builder()
        ...
        .defaultValue("Minecraft {mc_version} - {peakeor.name} {peakeor.version}")
        .onChanged(_ -> mc.updateTitle())
        .build()
    );
    ...
    public final Setting<Boolean> chatFeedback = sgChat.add(new BoolSetting.Builder()
        .name("chat-feedback")
        .description("Sends chat feedback when peakeor performs certain actions.")
        .defaultValue(true)
        .build()
    );
    ...
    public CompoundTag toTag() {
        ...
        tag.putString("version", PeakeorClient.VERSION.toString());

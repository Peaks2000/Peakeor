...
import peakeordevelopment.peakeorclient.renderer.*;
import peakeordevelopment.peakeorclient.renderer.text.CustomTextRenderer;
import peakeordevelopment.peakeorclient.renderer.text.Font;
import peakeordevelopment.peakeorclient.renderer.text.VanillaTextRenderer;
...
public class HudRenderer {
            ...
            for (Iterator<FontHolder> it = fontsInUse.values().iterator(); it.hasNext(); ) {
                ...
                if (fontHolder.visited) {
                    MeshRenderer.begin()
                        ...
                        .pipeline(PeakeorRenderPipelines.UI_TEXT)
    ...
    private static class FontHolder {
        ...
        public MeshBuilder getMesh() {
            if (mesh == null) mesh = new MeshBuilder(PeakeorRenderPipelines.UI_TEXT);

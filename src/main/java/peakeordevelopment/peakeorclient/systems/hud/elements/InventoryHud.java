...
public class InventoryHud extends HudElement {
    ...
    private static final Identifier TEXTURE = PeakeorClient.identifier("textures/container.png");
    private static final Identifier TEXTURE_TRANSPARENT = PeakeorClient.identifier("textures/container-transparent.png");

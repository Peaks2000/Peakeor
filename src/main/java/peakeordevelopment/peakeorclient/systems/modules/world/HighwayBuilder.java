...
import peakeordevelopment.peakeorclient.mixin.MinecraftMixin;
import peakeordevelopment.peakeorclient.mixin.ShulkerBoxMenuAccessor;
...
import peakeordevelopment.peakeorclient.systems.modules.combat.KillAura;
...
import peakeordevelopment.peakeorclient.utils.misc.HorizontalDirection;
import peakeordevelopment.peakeorclient.utils.misc.MBlockPos;
import peakeordevelopment.peakeorclient.utils.player.*;
...
public class HighwayBuilder extends Module {
    ...
    /* todo
        ...
        - do something about lava flowing in
     */
        ...
        Forward {
            ...
            private boolean isCrystalTrap(HighwayBuilder b) {
                for (Entity entity : b.mc.level.entitiesForRendering()) {
                    ...
                    ((IVec3) vec1).peakeor$set(b.mc.player.getX(), b.mc.player.getY() + b.mc.player.getEyeHeight(), b.mc.player.getZ());
                    ((IVec3) vec2).peakeor$set(entity.getX(), entity.getY() + 0.5, entity.getZ());
                ...
                switch (blockState.getBlock()) {
                    ...
                    case ShulkerBoxBlock _ -> {
                        if (b.mc.gui.screen() instanceof ShulkerBoxScreen screen) {
                            ...
                            Container inv = ((ShulkerBoxMenuAccessor) screen.getMenu()).peakeor$getContainer();

...
package peakeordevelopment.peakeorclient.systems.modules.misc.swarm;
...
public class Swarm extends Module {
    ...
    public Swarm() {
        super(Categories.Misc, "swarm", "Allows you to control multiple instances of Peakeor from one central host.");
    }

...
public class DiscordPresence extends Module {
    ...
    public DiscordPresence() {
        super(Categories.Misc, "discord-presence", "Displays Peakeor as your presence on Discord.");
        ...
        if (Utils.canUpdate()) {
            ...
            if (line1Ticks >= line1UpdateDelay.get() || forceUpdate) {
                if (!line1Scripts.isEmpty()) {
                    ...
                    String message = PeakeorStarscript.run(line1Scripts.get(i));
            ...
            if (line2Ticks >= line2UpdateDelay.get() || forceUpdate) {
                if (!line2Scripts.isEmpty()) {
                    ...
                    String message = PeakeorStarscript.run(line2Scripts.get(i));
            ...
            if (!lastWasInMainMenu) {
                ...
                else if (mc.gui.screen() instanceof WidgetScreen) rpc.setState("Browsing Peakeor's GUI");

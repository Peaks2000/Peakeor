...
import peakeordevelopment.peakeorclient.systems.modules.misc.AutoReconnect;
...
public class AutoLog extends Module {
    ...
    private void enableHealthListener() {
        PeakeorClient.EVENT_BUS.subscribe(staticListener);
    }

    private void disableHealthListener() {
        PeakeorClient.EVENT_BUS.unsubscribe(staticListener);
    }
}

...
package peakeordevelopment.peakeorclient.systems.modules.movement.elytrafly.modes;

import peakeordevelopment.peakeorclient.PeakeorClient;
import peakeordevelopment.peakeorclient.events.packets.PacketEvent;
import peakeordevelopment.peakeorclient.systems.modules.movement.elytrafly.ElytraFlightMode;
    ...
    private static boolean startGliding(LocalPlayer player) {
        for (EquipmentSlot equipmentSlot : EquipmentSlot.VALUES) {
            if (LivingEntity.canGlideUsing(player.getItemBySlot(equipmentSlot), equipmentSlot)) {
                PeakeorClient.mc.executeIfPossible(player::startFallFlying);
                return true;
            }
        }

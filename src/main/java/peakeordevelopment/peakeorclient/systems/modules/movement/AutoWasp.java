    ...
    private void onMove(PlayerMoveEvent event) {
        ...
        if (avoidLanding.get()) {
            ...
            for (Direction dir : DirectionAccessor.peakeor$getHorizontal()) {
                ...
                if (((BlockBehaviourAccessor) mc.level.getBlockState(pos).getBlock()).peakeor$isHasCollision() && Math.abs(targetPos.y() - (pos.getY() + 1)) <= 0.25) {
        ...
        ((IVec3) event.movement).peakeor$set(xVel, yVel, zVel);
    }

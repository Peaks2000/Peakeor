...
import peakeordevelopment.peakeorclient.mixin.LivingEntityAccessor;
...
public class FastClimb extends Module {
    ...
    private boolean climbing() {
        return (mc.player.horizontalCollision || ((LivingEntityAccessor) mc.player).peakeor$isJumping()) && (mc.player.onClimbable() || mc.player.getInBlockState().is(Blocks.POWDER_SNOW) && PowderSnowBlock.canEntityWalkOnPowderSnow(mc.player));
    }
}

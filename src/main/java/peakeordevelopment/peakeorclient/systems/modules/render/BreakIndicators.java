...
import peakeordevelopment.peakeorclient.systems.modules.world.PacketMine;
...
public class BreakIndicators extends Module {
    ...
    private void renderNormal(Render3DEvent event) {
        float ownBreakingStage = ((MultiPlayerGameModeAccessor) mc.gameMode).peakeor$getBreakingProgress();
        BlockPos ownBreakingPos = ((MultiPlayerGameModeAccessor) mc.gameMode).peakeor$getCurrentBreakingBlockPos();

...
import peakeordevelopment.peakeorclient.events.render.TooltipDataEvent;
import peakeordevelopment.peakeorclient.gui.screens.ContainerInventoryScreen;
import peakeordevelopment.peakeorclient.mixin.EntityAccessor;
import peakeordevelopment.peakeorclient.mixin.MobBucketItemAccessor;
...
import peakeordevelopment.peakeorclient.utils.misc.ByteCountDataOutput;
...
import peakeordevelopment.peakeorclient.utils.tooltip.*;
...
public class BetterTooltips extends Module {
    ...
    private void getTooltipData(TooltipDataEvent event) {
        ...
        // Fish peek
            ...
            EntityType<?> type = ((MobBucketItemAccessor) bucketItem).peakeor$getType();
            ...
            if (entity != null) {
                ...
                ((EntityAccessor) entity).peakeor$setInWater(true);

...
import peakeordevelopment.peakeorclient.events.world.AmbientOcclusionEvent;
...
import peakeordevelopment.peakeorclient.mixin.BlockEntityRenderStateAccessor;
...
public class Xray extends Module {
    ...
    private void onRenderBlockEntity(RenderBlockEntityEvent event) {
        BlockState state = ((BlockEntityRenderStateAccessor) event.blockEntityState).peakeor$getBlockState();

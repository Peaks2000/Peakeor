...
import peakeordevelopment.peakeorclient.gui.screens.settings.*;
import peakeordevelopment.peakeorclient.gui.themes.peakeor.widgets.WPeakeorLabel;
...
public class DefaultSettingsWidgetFactory extends SettingsWidgetFactory {
    ...
    private static class WSelectedCountLabel extends WPeakeorLabel {

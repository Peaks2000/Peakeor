...
public class WPeakeorTextBox extends WTextBox implements PeakeorWidget {
    private boolean cursorVisible;
    private double cursorTimer;

    private double animProgress;

    public WPeakeorTextBox(String text, String placeholder, CharFilter filter, Class<? extends Renderer> renderer) {
    ...
    private static class CompletionItem extends WPeakeorLabel implements ICompletionItem {

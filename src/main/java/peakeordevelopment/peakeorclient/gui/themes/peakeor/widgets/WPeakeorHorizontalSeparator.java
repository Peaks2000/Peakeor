...
import peakeordevelopment.peakeorclient.gui.widgets.WHorizontalSeparator;

public class WPeakeorHorizontalSeparator extends WHorizontalSeparator implements PeakeorWidget {
    public WPeakeorHorizontalSeparator(String text) {
        super(text);
    }

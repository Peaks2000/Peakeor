...
public class WPeakeorDropdown<T> extends WDropdown<T> implements PeakeorWidget {
    public WPeakeorDropdown(T[] values, T value) {
        super(values, value);
    }
    ...
    private static class WRoot extends WDropdownRoot implements PeakeorWidget {
        @Override
        protected void onRender(GuiRenderer renderer, double mouseX, double mouseY, double delta) {
            PeakeorGuiTheme theme = theme();
    ...
    private class WValue extends WDropdownValue implements PeakeorWidget {
        @Override

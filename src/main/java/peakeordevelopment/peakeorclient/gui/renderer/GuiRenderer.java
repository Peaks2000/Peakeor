...
package peakeordevelopment.peakeorclient.gui.renderer;
...
import peakeordevelopment.peakeorclient.gui.renderer.operations.TextOperation;
import peakeordevelopment.peakeorclient.gui.renderer.packer.GuiTexture;
import peakeordevelopment.peakeorclient.gui.renderer.packer.TexturePacker;
import peakeordevelopment.peakeorclient.gui.widgets.WWidget;
import peakeordevelopment.peakeorclient.renderer.Renderer2D;
import peakeordevelopment.peakeorclient.renderer.Texture;
import peakeordevelopment.peakeorclient.utils.PostInit;
import peakeordevelopment.peakeorclient.utils.misc.Pool;
...
public class GuiRenderer {
    ...
    public static void init() {
        CIRCLE = addTexture(PeakeorClient.identifier("textures/icons/gui/circle.png"));
        TRIANGLE = addTexture(PeakeorClient.identifier("textures/icons/gui/triangle.png"));
        EDIT = addTexture(PeakeorClient.identifier("textures/icons/gui/edit.png"));
        RESET = addTexture(PeakeorClient.identifier("textures/icons/gui/reset.png"));
        FAVORITE_NO = addTexture(PeakeorClient.identifier("textures/icons/gui/favorite_no.png"));
        FAVORITE_YES = addTexture(PeakeorClient.identifier("textures/icons/gui/favorite_yes.png"));

        COPY = addTexture(PeakeorClient.identifier("textures/icons/gui/copy.png"));
        PASTE = addTexture(PeakeorClient.identifier("textures/icons/gui/paste.png"));

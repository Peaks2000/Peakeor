...
public class GuiDebugRenderer {
    ...
    private final MeshBuilder mesh = new MeshBuilder(PeakeorRenderPipelines.WORLD_COLORED_LINES);
    ...
    public void render(WWidget widget) {
        ...
        MeshRenderer.begin()
            ...
            .pipeline(PeakeorRenderPipelines.WORLD_COLORED_LINES)
            .mesh(mesh)
            .end();
    }
    ...
    public void mouseReleased(WWidget widget, MouseButtonEvent click, int i) {
        ...
        PeakeorClient.LOG.info("{} {}", widget.getClass(), i);

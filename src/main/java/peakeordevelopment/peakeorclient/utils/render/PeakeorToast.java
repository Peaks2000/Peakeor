...
public class PeakeorToast implements Toast {
    private static final int TITLE_COLOR = Color.fromRGBA(242, 140, 40, 255);
    ...
    private PeakeorToast(Builder builder) {
    ...
    public static class Builder {
        ...
        public PeakeorToast build() {
            return new PeakeorToast(this);
        }
    }

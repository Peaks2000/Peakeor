...
public class Capes {
    ...
    public static void init() {
        ...
        PeakeorClient.EVENT_BUS.subscribe(Capes.class);
    }
    ...
    private static class Cape {
        ...
        public Cape(String name) {
            this.identifier = PeakeorClient.identifier("capes/" + COUNT++);
            this.name = name;
        }
        ...
        public void download() {
            ...
            PeakeorExecutor.execute(() -> {
                try {
                    ...
                    PeakeorClient.LOG.error("Failed to download cape '{}'", name, e);
                }
            });
        }

...
import peakeordevelopment.peakeorclient.systems.modules.movement.NoFall;
...
import peakeordevelopment.peakeorclient.utils.misc.text.TextUtils;
...
import static peakeordevelopment.peakeorclient.utils.Utils.WHITE;
...
public class PlayerUtils {
    ...
    public static Vec3 getHorizontalVelocity(double bps) {
        ...
        ((IVec3) horizontalVelocity).peakeor$setXZ(velX, velZ);
    ...
    public static boolean canSeeEntity(Entity entity) {
        ...
        ((IVec3) vec1).peakeor$set(mc.player.getX(), mc.player.getY() + mc.player.getEyeHeight(), mc.player.getZ());
        ((IVec3) vec2).peakeor$set(entity.getX(), entity.getY(), entity.getZ());
        ...
        ((IVec3) vec2).peakeor$set(entity.getX(), entity.getY() + entity.getEyeHeight(), entity.getZ());

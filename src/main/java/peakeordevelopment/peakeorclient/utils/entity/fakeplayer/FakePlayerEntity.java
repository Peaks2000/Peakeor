...
package peakeordevelopment.peakeorclient.utils.entity.fakeplayer;

import com.mojang.authlib.GameProfile;
import peakeordevelopment.peakeorclient.mixin.AbstractClientPlayerAccessor;
...
public class FakePlayerEntity extends RemotePlayer {
    ...
    @Override
    public int getId() {
        return ((EntityAccessor) this).peakeor$getId();
    }
    ...
    protected PlayerInfo getPlayerInfo() {
        ...
        if (entry == null) {
            ((AbstractClientPlayerAccessor) this).peakeor$setPlayerInfo(mc.getConnection().getPlayerInfo(mc.player.getUUID()));
        }

...
package peakeordevelopment.peakeorclient;
...
import peakeordevelopment.peakeorclient.gui.tabs.Tabs;
import peakeordevelopment.peakeorclient.systems.Systems;
import peakeordevelopment.peakeorclient.systems.config.Config;
import peakeordevelopment.peakeorclient.systems.hud.screens.AddHudElementScreen;
import peakeordevelopment.peakeorclient.systems.hud.screens.HudEditorScreen;
import peakeordevelopment.peakeorclient.systems.hud.screens.HudElementScreen;
...
import peakeordevelopment.peakeorclient.systems.modules.misc.DiscordPresence;
import peakeordevelopment.peakeorclient.utils.PostInit;
import peakeordevelopment.peakeorclient.utils.PreInit;
import peakeordevelopment.peakeorclient.utils.ReflectInit;
import peakeordevelopment.peakeorclient.utils.Utils;
import peakeordevelopment.peakeorclient.utils.misc.Version;
import peakeordevelopment.peakeorclient.utils.misc.input.KeyAction;
import peakeordevelopment.peakeorclient.utils.misc.input.KeyBinds;
...
public class PeakeorClient implements ClientModInitializer {
    public static final String MOD_ID = "peakeor-client";
    public static final ModMetadata MOD_META;
    public static final String NAME;
    public static final Version VERSION;
    public static final String BUILD_NUMBER;

    public static PeakeorClient INSTANCE;
    public static PeakeorAddon ADDON;
    ...
    static {
        ...
        BUILD_NUMBER = MOD_META.getCustomValue(PeakeorClient.MOD_ID + ":build_number").getAsString();
    }
    ...
    public void onInitializeClient() {
        ...
        // Initialise addons
        AddonManager.ADDONS.forEach(PeakeorAddon::onInitialize);
    ...
    public static Identifier identifier(String path) {
        return Identifier.fromNamespaceAndPath(PeakeorClient.MOD_ID, path);
    }
}
